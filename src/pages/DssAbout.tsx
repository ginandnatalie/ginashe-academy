    ...
    <div className="min-h-screen bg-bg">
      ...
      <section className="py-20 relative z-10 border-t border-white/5 bg-bg2">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <h2 className="text-3xl font-syne font-black text-white uppercase tracking-tighter mb-4">DSS Architecture</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-2xl font-syne font-black text-white uppercase">Stream Governance</h3>
              </div>
            ...
            <div className="bg-white/[0.02] border border-white/5 p-10 rounded-3xl flex flex-col justify-center items-center text-center">
              <BookOpen className="w-12 h-12 text-brand mb-6" />
              <h3 className="text-2xl font-syne font-black text-white uppercase mb-4">Institutional Standards</h3>
