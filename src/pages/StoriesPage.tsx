  ...
  return (
    <div className="min-h-screen bg-bg pt-20 px-6">
      <SEO 
        ...
        description="Read reviews and success stories from learners and hiring partners." 
      />
      <div className="max-w-7xl mx-auto py-20 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center gap-6">
          ...
          <h1 className="text-4xl md:text-5xl font-syne font-black text-text-custom uppercase tracking-tighter">Graduate Stories</h1>
