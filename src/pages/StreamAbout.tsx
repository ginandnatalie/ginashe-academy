    ...
    <div className="min-h-screen bg-bg pt-12 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-syne font-black text-text-custom mb-6">Mission & Mandate</h1>
          
          <div className="bg-glass-bg border border-border-custom p-8 rounded-3xl mb-8">
            <h2 className="font-syne font-bold text-2xl text-text-custom mb-4">Strategic Purpose</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-glass-bg border border-border-custom p-8 rounded-3xl">
              ...
              <h2 className="font-syne font-bold text-xl text-text-custom mb-3">Industry Alignment</h2>
            ...
            <div className="bg-glass-bg border border-border-custom p-8 rounded-3xl">
              ...
              <h2 className="font-syne font-bold text-xl text-text-custom mb-3">Graduate Profiles</h2>
              <p className="text-text-muted font-outfit leading-relaxed">
                Graduates from the {stream.abbr} typically step into roles such as: <br/><br/>
                <span className="text-text-custom font-medium">{stream.graduates}</span>
              </p>
            </div>
          </div>
        </motion.div>
