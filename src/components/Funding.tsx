...
export function FAQ({ onOpenModal, editMode }: { onOpenModal: (id: string) => void, editMode?: boolean }) {
  ...
  const faqs = [
    ...
    // Programmes
    { cat: 'programmes', q: 'Are Ginashe Academy programmes accredited by SETA or QCTO?', a: 'Ginashe Academy is currently an independent, practitioner-led institution. Our curricula are meticulously aligned with SETA and QCTO unit standard qualification frameworks, while we actively work towards formal accreditation. In parallel, our technical curricula prepare learners directly for globally recognized vendor credentials (AWS, Azure, Google Cloud, CompTIA).' },
