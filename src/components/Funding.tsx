      ...
      <div className="section-inner">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-10 lg:gap-16 mb-14 items-center">
          <div className="max-w-[540px]">
            ...
            <p className="section-sub animate-fadeUp delay-100">Ginashe Academy programmes can be funded through merit-based scholarships, employer training budgets, or our flexible payment plans. Every option, explained clearly.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-border-custom border border-border-custom rounded-3xl overflow-hidden mb-8 animate-fadeUp">
          <div className="bg-card p-6 sm:p-9 px-6 sm:px-7.5 relative overflow-hidden flex flex-col transition-colors hover:bg-card2 before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-0.75 before:bg-[linear-gradient(90deg,var(--color-emerald),#2e9e7a)]">
            ...
            <div className="font-syne font-extrabold text-[18px] mb-2.5">Ginashe Academy Excellence Scholarship</div>
          ...
          <div className="bg-card p-6 sm:p-9 px-6 sm:px-7.5 relative overflow-hidden flex flex-col transition-colors hover:bg-card2 before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-0.75 before:bg-[linear-gradient(90deg,var(--color-sky),#0288d1)]">
            ...
            <div className="text-[13px] text-text-soft leading-[1.65] mb-5 flex-1">Many South African companies have annual training budgets that go unspent. Ginashe Academy works directly with HR and L&D teams to invoice your company, structure multi-learner cohorts, and provide all ATR reporting.</div>
            <ul className="list-none flex flex-col gap-2.25 mb-5.5">
              {['Ginashe Academy issues a formal tax invoice directly to your employer', 'Net30/60 corporate payment terms available', 'Group discounts from 3+ learners enrolled simultaneously', 'Custom reporting packs for your HR and L&D team', 'Content customisable to your tech stack at no extra cost'].map((li, i) => (
                <li key={i} className="flex gap-2 text-[12px] items-start">
        ...
        <div className="bg-surface border border-border-custom rounded-3xl p-6 sm:p-10 animate-fadeUp">
          <div className="font-syne font-extrabold text-[20px] mb-1.5">How to apply for a Ginashe Academy Bursary — step by step</div>
...
export function FAQ({ onOpenModal, editMode }: { onOpenModal: (id: string) => void, editMode?: boolean }) {
  ...
  const faqs = [
    ...
    { cat: 'admissions', q: 'Is there an age limit for Ginashe Academy applicants?', a: 'Ginashe Academy is open to all lifelong learners. While our Excellence Scholarship primarily targets the 18–35 demographic to address youth unemployment, we have practitioners from 18 to 65 enrolled in various tracks. We value technical curiosity over chronological age.' },
    { cat: 'admissions', q: 'Do you accept international students?', a: 'Yes. Ginashe Academy is a global-first academy. As long as you have a stable internet connection and can attend sessions in the Central African Time (CAT) or Greenwich Mean Time (GMT) zones, you are eligible to join our cohorts. All instruction is in English.' },
    ...
    // Programmes
    { cat: 'programmes', q: 'Are Ginashe Academy programmes accredited by SETA or QCTO?', a: 'Ginashe Academy is an independent, practitioner-led institution. We focus on "Institutional Mastery" and global industry vendor certifications (AWS, Azure, Google Cloud, NVIDIA) rather than local government accreditation. This allows us to update our curriculum weekly to match the speed of the tech industry.' },
    ...
    { cat: 'programmes', q: 'Who designs the Ginashe Academy curriculum?', a: 'Our curriculum is built and updated by "Active Practitioners" — senior engineers, architects, and data scientists currently working in top-tier global tech firms. You learn what is being used in production today, not what was in a textbook five years ago.' },
    { cat: 'programmes', q: 'What is the ratio of theory to practice?', a: 'Ginashe Academy follows an 80/20 rule: 80% hands-on laboratory work and project deployment, and 20% theoretical framework. We believe you only truly understand a system once you have broken and fixed it in a live environment.' },
    ...
    { cat: 'programmes', q: 'Do I get a certificate upon completion?', a: 'Yes. Graduates receive a Ginashe Academy "Mastery Certificate" and digital credentials (NFT-backed for verification). Additionally, we prepare you for 2–4 global vendor certifications relevant to your track.' },
    ...
    { cat: 'faq-funding', q: 'Is there a discount for upfront payment?', a: 'Yes. Students who pay their full tuition upfront receive a 15% Early-Bird discount. This is the most cost-effective way to enroll at Ginashe Academy.' },
    ...
    // Learning
    { cat: 'learning', q: 'Is learning 100% remote or are there campuses?', a: 'Ginashe Academy is a digital-first institution. While we are 100% remote-capable, we host regular "Physical Pop-Up Labs" in major hubs (Johannesburg, Cape Town, Nairobi) for intensive hacking sessions and networking.' },
    ...
    { cat: 'learning', q: 'Do I get access to a community of other students?', a: 'Yes. All Ginashe Academy students are integrated into our private Discord and Ginashe Portal. You will collaborate on projects, participate in internal hackathons, and join track-specific study groups.' },
    ...
    { cat: 'learning', q: 'What is the exam structure at Ginashe Academy?', a: 'We do not have traditional pen-and-paper exams. Your "final" is a Capstone Project — a production-ready application or infrastructure deployment that you must present to a panel of industry practitioners.' },

    // Outcomes
    { cat: 'outcomes', q: 'Does Ginashe Academy guarantee job placement?', a: 'While we do not "guarantee" jobs (no honest institution can), we have a 92% placement rate within 6 months of graduation. Our Career Services team works tirelessly to connect you with our hiring partners.' },
    ...
    { cat: 'outcomes', q: 'Can I work for international companies from Africa?', a: 'Yes. A core focus of Ginashe Academy is "Global Arbitrage." We train you to work remotely for firms in Europe and the US while based in Africa, allowing you to earn global-tier salaries.' },
    ...
    { cat: 'outcomes', q: 'Who are Ginashe Academy\'s industry partners?', a: 'We partner with global cloud providers (AWS, Google Cloud), technical recruitment firms, and African fintech/enterprise leaders to ensure our curriculum and graduates remain in high demand.' }
  ];
