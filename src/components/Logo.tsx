  ...
  if (showWhite) {
    ...
    return (
      <svg width="850" height="250" viewBox="0 0 850 250" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <defs>
          <linearGradient id="lineFadeWhite" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stop-color="#ffffff" stop-opacity="0.4"/>
            <stop offset="100%" stop-color="#ffffff" stop-opacity="0"/>
          </linearGradient>

          <g id="master-circuit-white">
          ...
          <g id="master-circuit-flow-white">
          ...
          <style>
            {`
              ...
              .word-ginashe-white { font-family: 'Montserrat', sans-serif; font-weight: 900; font-size: 82px; }
              .word-academy-white { font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 26px; text-transform: uppercase; letter-spacing: 0.5em; opacity: 1; }
              
              @keyframes flowDataWhite {
              ...
              .tech-flow-white {
                ...
                animation: flowDataWhite 10s infinite cubic-bezier(0.2, 0, 0.2, 1);
              }
              
              @keyframes circuitPulseWhite {
              ...
              .tech-pulse {
                ...
                animation: circuitPulseWhite 4s infinite linear;
              }
        ...
        <g transform="translate(15, 10)">
          ...
          <g stroke="#ffffff" strokeWidth="1.5" opacity="0.4">
            <use href="#master-circuit-white" />
            <use href="#master-circuit-white" transform="translate(250, 0) scale(-1, 1)" />
            <path d="M 125 35 L 125 65 M 125 185 L 125 225" strokeDasharray="2 4" strokeWidth="2" opacity="0.5" />
          </g>
          <g>
            <use href="#master-circuit-flow-white" />
            <use href="#master-circuit-flow-white" transform="translate(250, 0) scale(-1, 1)" />
          </g>
        ...
        <text x="290" y="125" className="word-ginashe-white" fill="#ffffff" textLength="480" lengthAdjust="spacing">GINASHE</text>
        ...
        <line x1="290" y1="145" x2="840" y2="145" stroke="url(#lineFadeWhite)" strokeWidth="10" strokeLinecap="round"/>
        ...
        <line className="tech-flow-white" x1="290" y1="145" x2="840" y2="145" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>

        <text x="290" y="182" className="word-academy-white" fill="#ffffff" textLength="480" lengthAdjust="spacing">ACADEMY</text>
      </svg>
    );
  }
  ...
  return (
    <svg width="850" height="250" viewBox="0 0 850 250" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        ...
        <g id="master-circuit-flow-black">
          <path className="tech-pulse c-delay-1" d="M 75 70 L 80 70 L 95 85 L 105 85" fill="none" />
          <path className="tech-pulse c-delay-2" d="M 65 105 L 80 105 L 90 115 L 105 115" fill="none" />
          <path className="tech-pulse c-delay-3" d="M 55 140 L 70 140 L 85 125 L 100 125" fill="none" />
        </g>
        ...
        <style>
          {`
            @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@900&family=Outfit:wght@500;700&display=swap');
            .word-ginashe-black { font-family: 'Montserrat', sans-serif; font-weight: 900; font-size: 82px; }
            .word-academy-black { font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 26px; text-transform: uppercase; letter-spacing: 0.5em; opacity: 1; }
            
            @keyframes flowDataBlack {
              0%, 80% { stroke-dashoffset: 50; opacity: 0; }
              82% { opacity: 1; }
              98% { opacity: 1; }
              100% { stroke-dashoffset: -450; opacity: 0; }
            ...
            .tech-flow-black {
              stroke-dasharray: 40 1000;
              animation: flowDataBlack 10s infinite cubic-bezier(0.2, 0, 0.2, 1);
            }

            @keyframes circuitPulseBlack {
              0%, 80% { stroke-dashoffset: 60; opacity: 0; }
              85% { opacity: 1;  }
              95% { opacity: 1;  }
              100% { stroke-dashoffset: -60; opacity: 0; }
            ...
            .tech-pulse {
              ...
              stroke-linecap: round;
              stroke-dasharray: 15 120;
              animation: circuitPulseBlack 4s infinite linear;
            }
            .c-delay-1 { animation-delay: 0s; }
            .c-delay-2 { animation-delay: 1.3s; }
            .c-delay-3 { animation-delay: 2.6s; }
      ...
      <g transform="translate(15, 10)">
        ...
        <g stroke="#0B0C10" strokeWidth="1.5" opacity="0.4">
          <use href="#master-circuit-black" />
          <use href="#master-circuit-black" transform="translate(250, 0) scale(-1, 1)" />
          <path d="M 125 35 L 125 65 M 125 185 L 125 225" strokeDasharray="2 4" strokeWidth="2" opacity="0.5" />
        </g>
        <g>
          <use href="#master-circuit-flow-black" />
          <use href="#master-circuit-flow-black" transform="translate(250, 0) scale(-1, 1)" />
        </g>
      ...
      <text x="290" y="125" className="word-ginashe-black" fill="#000000" textLength="480" lengthAdjust="spacing">GINASHE</text>
      
      <line x1="290" y1="145" x2="770" y2="145" stroke="#00f2ff" strokeWidth="20" opacity="0.05" strokeLinecap="round"/>
      <line x1="290" y1="145" x2="770" y2="145" stroke="#00f2ff" strokeWidth="12" opacity="0.15" strokeLinecap="round"/>
      
      <line x1="290" y1="145" x2="840" y2="145" stroke="url(#lineFadeBlack)" strokeWidth="10" strokeLinecap="round"/>
      <line x1="290" y1="145" x2="770" y2="145" stroke="#0B0C10" strokeWidth="10" strokeLinecap="round" />

      <line x1="290" y1="145" x2="770" y2="145" stroke="#00f2ff" strokeWidth="4" strokeLinecap="round" />

      <line className="tech-flow-black" x1="290" y1="145" x2="840" y2="145" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>

      <text x="290" y="182" className="word-academy-black" fill="#000000" textLength="480" lengthAdjust="spacing">ACADEMY</text>
    </svg>
  );
}
